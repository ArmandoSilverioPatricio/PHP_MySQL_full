...
<body>
    <?php
		...
		*/
		...
		/*for($i = 0; $i < count($resultQueryProd); $i ++ ){
			$fila = mysqli_fetch_row($resultQueryProd); 
			//Almacenando los datos en un array que en este caso el fila
		...
		while(($fila=mysqli_fetch_row($resultQueryProd)) == true){
			echo $fila[0] . "<br>";
			echo $fila[1] . "<br>";
			echo $fila[2] . "<br>";
			echo $fila[3] . "<br>";
